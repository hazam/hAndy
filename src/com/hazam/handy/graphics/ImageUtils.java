...
public class ImageUtils {
	public static Bitmap buildReflectedBitmap(final Bitmap orig, final int spacing, int startAlpha,
			float reflectionQuota) {
		...
		Bitmap reflectionImage = Bitmap.createBitmap(orig, 0, height - reflectedHeight, width, reflectedHeight, matrix,
				false);
		...
		LinearGradient shader = new LinearGradient(0, height + spacing, // punto dai cui parte il gradiente
